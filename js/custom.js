$(document).ready(function () {
 $(window).scroll(function(){
    $("dissolve, .newsletter-home-text").css("opacity", 1 - $(window).scrollTop() / 350);
  });
    
    // scroll down a little on click " MORE FEATURES " how?
    ...
    $(window).scroll(function () {
        ...
        if ($(window).scrollTop() > 50) {
            ...
            //jQuery('#logo').attr('src','images/logo1_small.png')
             ...
             //jQuery('#logo').attr('src','images/logo1_white_small.png')
         }
    });
//smooth scroll
    $(function () {
